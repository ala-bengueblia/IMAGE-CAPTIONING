...
def execute_scripts():
    try:
        ...
        log_text.insert(tk.END, f"{description}\n")
...
descriptions = {
    ...
    "C:/Users/alabe/OneDrive/Bureau/CODSOFT/task3/images/image3.jpeg": [" oiseausur l'arbre", " oiseau_multicolore"],
    "C:/Users/alabe/OneDrive/Bureau/CODSOFT/task3/images/image4.jpeg": [" vache   jardin", " vache_noire-blanche"],
...
root = tk.Tk()
root.title("Image Captioning Execution")
root.configure(bg='#e0f7fa')

frame = tk.Frame(root, bg='#ffffff')
frame.pack(padx=10, pady=10)

# Entrée pour le nombre d'époques
epochs_label = tk.Label(frame, text="Number of Epochs:", bg='#ffffff', font=('Arial', 12))
epochs_label.pack(pady=5)
epochs_entry = tk.Entry(frame, width=10, font=('Arial', 12))
epochs_entry.insert(0, "10")
epochs_entry.pack(pady=5)

# Entrée pour le taux de dropout
dropout_rate_label = tk.Label(frame, text="Dropout Rate:", bg='#ffffff', font=('Arial', 12))
dropout_rate_label.pack(pady=5)
dropout_rate_entry = tk.Entry(frame, width=10, font=('Arial', 12))
dropout_rate_entry.insert(0, "0.5")
dropout_rate_entry.pack(pady=5)

# Entrée pour la taille des couches denses
dense_units_label = tk.Label(frame, text="Dense Units:", bg='#ffffff', font=('Arial', 12))
dense_units_label.pack(pady=5)
dense_units_entry = tk.Entry(frame, width=10, font=('Arial', 12))
dense_units_entry.insert(0, "256")
dense_units_entry.pack(pady=5)

# Entrée pour le fichier image
image_path = tk.StringVar(value='')
load_button = tk.Button(frame, text="Load Image", command=load_image, bg='#009688', fg='#ffffff', font=('Arial', 12))
...
# Case à cocher pour enregistrer les résultats
save_results = tk.BooleanVar()
save_results_check = tk.Checkbutton(frame, text="Save Results", variable=save_results, bg='#ffffff', font=('Arial', 12))
save_results_check.pack(pady=5)

# Bouton pour exécuter les scripts
execute_button = tk.Button(frame, text="Execute Scripts", command=execute_scripts, bg='#4CAF50', fg='#ffffff', font=('Arial', 12))
execute_button.pack(pady=5)

# Zone de texte pour afficher les logs
log_text = scrolledtext.ScrolledText(frame, width=80, height=20, bg='#f1f8e9', fg='#000000', font=('Arial', 12))
